"""
Django settings for flood_monitoring project.
...
SECRET_KEY = 'django-insecure-@_%(#55j0$scfskch)b=-^+sgkjnb%bpqt%$@uqe1u8d+dnd*('
...
LOGGING = {
    ...
    # Define formatters to specify the format of log messages.
    'formatters': {
        'verbose': {
    ...
    # Define handlers to specify where log messages are sent.
    'handlers': {
        'console': {
            'level': 'DEBUG',
    ...
    # Define loggers to capture log messages.
    'loggers': {
        'django': {
